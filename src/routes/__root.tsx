...
const SITE_DESCRIPTION =
  "OBJEKT//404 — a real-time gallery of uncatalogued 3D artifacts. Scroll, rotate, and decode post-physical objects rendered live in your browser.";
